...
import { type IThumbnail, type AspectRatio, colorSchemes, type ThumbnailStyle } from "../assets/";
...
const [styleDropdown, setStyleDropdown] = useState<boolean>(false);
                ...
                <div className="space-y-5">
                  ...
                  <div className="space-y-2">
                    ...
                    <input
                      ...
                      maxLength={100}
                      placeholder="e.g. 10 tips to better sleep"
                  ...
                  <ColorSchemeSelector
                    value={colorSchemeId} onChange={setColorSchemeId}
                  />
