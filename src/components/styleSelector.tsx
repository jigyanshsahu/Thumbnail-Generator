...
import { thumbnailStyles, type ThumbnailStyle } from "../assets";
...
const StyleSelector = ({ value, onChange, isOpen, setIsOpen }: Props) => {
  const styleDescriptions: Record<ThumbnailStyle, string> = {
    ...
    Photorealistic: "Photo-based, natural-looking visuals.",
    Illustrated: "Hand-drawn, artistic, colorful style.",
    "Tech/Futuristic": "Modern, sleek, digital elements.",
  };
